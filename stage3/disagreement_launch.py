...
def prepare_launch(args):
    ...
    knowledge, tasks = utils.get_knowledge_file(args), utils.get_stage_3_tasks(args)
    ...
    if len(remaining_tasks) == 0:
        ...
        if num_incomplete == 0:
            postfix = 'All images exhaustively labeled. Proceed to stage 4.'
        ...
        assert False, 'Stage 3 round %d disagreement launch done. %s' % (round_num, postfix)
